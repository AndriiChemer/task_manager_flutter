...
class MockUserRepository extends _i1.Mock implements _i5.UserRepository {
  ...
  _i3.Api get api =>
      (super.noSuchMethod(Invocation.getter(#api), returnValue: _FakeApi_2())
          as _i3.Api);
  @override
  _i4.Future<String> createUser(_i3.UserRequest? userRequest) =>
      (super.noSuchMethod(Invocation.method(#createUser, [userRequest]),
          returnValue: Future<String>.value('')) as _i4.Future<String>);
  @override
  _i4.Future<String> auth(_i3.UserRequest? userRequest) =>
      (super.noSuchMethod(Invocation.method(#auth, [userRequest]),
          returnValue: Future<String>.value('')) as _i4.Future<String>);
  @override
  String toString() => super.toString();
  @override

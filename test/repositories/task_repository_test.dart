...
import 'package:flutter_task_manager/features/data/task/task_repository_impl.dart';
...
@GenerateMocks([TaskApiDataSource, PaginationMapper, TaskMapper, FiltersPreferences])
void main() {

  late TaskApiDataSource mockApiProvider;
  late PaginationMapper mockPaginationMapper;
  late TaskMapper mockTaskMapper;
  late FiltersPreferences mockFiltersPreferences;
  late TaskRepository taskRepository;
  final mockException = Exception("Error");

  setUp(() {
    mockApiProvider = MockTaskApiDataSource();
    mockPaginationMapper = MockPaginationMapper();
    mockTaskMapper = MockTaskMapper();
    mockFiltersPreferences = MockFiltersPreferences();

    taskRepository = TaskRepositoryImpl(mockApiProvider, mockFiltersPreferences, mockTaskMapper, mockPaginationMapper);
  });
